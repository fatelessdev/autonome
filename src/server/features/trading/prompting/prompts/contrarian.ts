...
4. **Action:** If lower-band value is valid, enter LONG spot and target VWAP. If upper-band rejection is valid, HOLD unless closing an owned long whose thesis broke.
