...
| **Supertrend**| LONG/SHORT | **MACRO BIAS** | LONG supports buys; SHORT means bearish context, not a short-entry permission. |
...
* **Spot Only:** All new entries are long spot buys only. No margin, no perps, no naked sells, no short openings.
