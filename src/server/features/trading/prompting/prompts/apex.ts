...
Gains vanish fast. You must **LOCK IT IN**.
1. **Breakeven:** If Unrealized PnL > 15%, move Stop to Entry.
2. **Bank It:** If Unrealized PnL > 30%, Trail Stop to lock 15%.
