...
3. **Correlation:** Never open BTC if ETH is long (or vice versa). SOL/XRP/HYPE trade freely.
...
- **PROFIT?** If profit > 1.5R → close and reopen with tighter stop to trail (never widen)
...
3. Status with risk state (e.g., "Holding: BTC volume 4% of avg | risk capped", "Closed SOL zombie | DD halt active", "Opened XRP long | risk 50% throttle")
