...
C. **OPTIMIZE?** To tighten stops, close and reopen with better levels (never widen risk)

**STEP 2: SCAN FOR NEW TRADES**
Only if cash > $${MIN_CASH_BUFFER} AND exposure < 100%:
...
- Max exposure: 100% of equity (spot only, no leverage)
