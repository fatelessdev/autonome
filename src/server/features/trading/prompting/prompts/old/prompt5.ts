...
2. **Spot Only:** All positions are 1x (no leverage). Size positions via quantity, not leverage.
...
- **PROTECT?** If profit > 1.5R -> close and reopen with tighter stop (lock in gains).
...
Tools: \`createPosition\`, \`closePosition\`, \`holding\`.
