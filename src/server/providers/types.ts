/**
 * Broker & Market Data Provider Interfaces
 *
 * Ported from MAHORAGA's provider types, trimmed to what Autonome needs.
...
export interface BrokerProvider {
	...
	listOrders(params?: ListOrdersParams): Promise<BrokerOrder[]>;
